 ...
 */
hangout.UserInjection = function() {
 ...
 * and dom world.
 */
hangout.UserInjection.prototype.createTransferDOM = function() {
 ...
 */
hangout.UserInjection.prototype.init = function() {
 ...
 */
hangout.UserInjection.prototype.particpantExported = function() {
 ...
 */
hangout.UserInjection.prototype.fetchParticipantsList = function() {
 ...
 */
hangout.UserInjection.prototype.onExtensionRequest = function(request, sender, sendResponse) {
...
var injection = new hangout.serInjection();
injection.init();
